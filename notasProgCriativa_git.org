...
- Descrição:
  - Apresentação de protótipo de objeto artístico-exploratório em media de livre escolha (instalação, livro, video, web art, etc.) que faça uso de sistema computacional realizado em Processing.
- Formato de entrega:
