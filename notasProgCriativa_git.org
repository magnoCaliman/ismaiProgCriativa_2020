...
- Desafio
  - Criar *dois programas* de livre escolha que fazem uso do algoritmo de random walk. No nosso exemplo em aula, utilizamos como método para determinar a posição de um círculo em um plano 2D. Pense que outros elementos gráficos e seus parâmetros podem ser explorados criativamente.
